...
export default function Home() {
  return (
    <main className="flex m-auto bg-black flex-col items-center justify-between p-8 mt-14">
      ...
      <h3 className='text-2xl font-extrabold text-white p-8'>Ade Tola</h3>
      
      <p className='w-full px-4 max-w-2xl md:px-0 mx-auto py-9 text-base md:text-lg text-white lg:text-xl'>
      ...
      <Link href={"/posts"}>
        <p className="text-base text-white md:text-xl lg:text-2xl text-center md:text-left hover:text-red-500">
