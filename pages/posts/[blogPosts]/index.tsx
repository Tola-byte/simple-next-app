...
function ProjectPage(props: {
    ...
    return (
        <main className="flex bg-black flex-col m-auto items-center justify-between p-24">
            ...
            <p className='w-full max-w-2xl p-9 text-center align-baseline'>{ props.specificPostData?.content}</p>
            <br />
